...
public class LivroController {
	...
	@PutMapping
	public ResponseEntity<?> updateLivro(@RequestBody LivroDTO livro) {
		try {
			LivroDTO livroAtualizado = service.updateLivro(livro.getId(), livro);
	...
	public ResponseEntity<Object> removeLivro(@PathVariable Long idLivro) {
		
		try {
			service.removeLivro(idLivro);
